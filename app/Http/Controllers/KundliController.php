...
class KundliController extends Controller
{
    public function matchProfileKundli(Request $request)
    {
        ...
        $boy_birth_time = $boy_birth[1];

        //girl
        $girl_birth = explode(" ", $request->matching_dob);
        $girl_birth_date = $girl_birth[0];
        $girl_birth_time = $girl_birth[1];

        $post_request = array(
            "dp_payload" => array(
                "kundali_id" => -1,
                "kundali_name" => "mukesh kumar",
                "kundali_date" => date('d/m/Y', strtotime($boy_birth_date)),
                "kundali_time" => $boy_birth_time,
                "kundali_city" => "New Delhi",
                "kundali_state" => "NCT",
                ...
                "second_kundali_id" => -1,
                "second_kundali_name" => "arti khanna",
                "second_kundali_date" => date('d/m/Y', strtotime($girl_birth_date)),
                "second_kundali_time" => $girl_birth_time,
                "second_kundali_city" => "New Delhi",
