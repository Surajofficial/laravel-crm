            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-end">
                            <h3 class="mb-1 mt-0"> $<span data-plugin="counterup">958.25</span>
                            </h3>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-end">
                            <h3 class="mb-1 mt-0"> $<span data-plugin="counterup">89.25</span>
                            </h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row text-center">
                        <div class="col-6">
                            ...
                            <h3 class="mt-0 font-20"><span class="align-middle">$120,254</span>
                                <small class="badge badge-soft-success font-12">+15%</small></h3>
                        </div>

                        <div class="col-6">
                            <p class="text-muted mb-1">Last Month</p>
                            <h3 class="mt-0 font-20"><span class="align-middle">$98,741</span>
                                <small class="badge badge-soft-danger font-12">-5%</small></h3>
                        </div>
                    </div>
...
@section('custom-scripts')
  ...
  <!-- Dashboard init-->
  <script src="{{url('js/pages/dashboard-sales.init.js')}}"></script>
@endsection
