            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body table-responsive" style="overflow: scroll">
                        <div class="row">
                            <div class="col-md-10"><h4 class="header-title">User List</h4></div>
                            <div class="col-md-2">
                ...
                $.ajax({
                    ...
                    success: function(dataSave) {
                        if (dataSave.type == true) {
                            $('.show_output').html('<div class="alert alert-success alert-dismissible fade show" role="alert"> <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">&times;</span> <span class="sr-only">Close</span> </button> <strong>Holy guacamole!</strong> '+dataSave.message+'. </div>');
                            $('#user_form')[0].reset();
