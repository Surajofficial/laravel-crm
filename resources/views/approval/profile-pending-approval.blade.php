                        ...
                        <form method="post" action="{{ route('approveuserprofile') }}" id="addLeadForm" autocomplete="off"
                            ...
                            <div id="progressbarwizard">
                                ...
                                <ul class="nav nav-pills nav-justified form-wizard-header mb-3">
                                    <li class="nav-item">
                                        <a href="#profile-tab-1" data-bs-toggle="tab" data-toggle="tab"
                                            class="nav-link personal_nav_link">
                                    ...
                                    <li class="nav-item">
                                        <a href="#profile-tab-4" data-bs-toggle="tab" data-toggle="tab"
                                            class="nav-link photo_lonk">
                                ...
                                <div class="tab-content b-0 pt-0 mb-0">
                                    ...
                                    <div class="tab-pane active" id="profile-tab-1">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="row mb-3">
                                                    <label class="col-md-3 col-form-label" for="name1"> Profile
                                                        Creating
                                                        For</label>
                                                    <div class="col-md-3">
                                                ...
                                                <div class="row mb-3">
                                                    <label class="col-md-3 col-form-label" for="name1"> Full
                                                        name</label>
                                                    <div class="col-md-3">
                                                ...
                                                <div class="row md-3">
                                                    ...
                                                    <label class="col-md-3 col-form-label" for="surname1"> Manglik
                                                        Status</label>
                                                    <div class="col-md-3">
                                                        <select name="manglik_status" class="form-select"
                                                            id="manglik_status" required>
                                                        </select>
                                                    </div>
                                                    {{-- <label class="col-md-3 col-form-label" for="email1">Weight</label>
                                                <div class="col-md-3">
                                        ...
                                        <ul class="pager wizard mb-0 list-inline mt-2 first_link">
                                            <li class="previous list-inline-item disabled">
                                            </li>
                                            <li class="next list-inline-item float-end">
                                                <button type="button" class="btn btn-success link_to_profess">Go To
                                                    Professional Details <i class="mdi mdi-arrow-right ms-1"></i></button>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="tab-pane" id="profile-tab-3">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="row mb-3">
                                                    <label class="col-md-3 col-form-label" for="name1"> House
                                                        Type</label>
                                                    <div class="col-md-3">
                                        ...
                                        <ul class="pager wizard mb-0 list-inline mt-2 custom_add_buttons">
                                    ...
                                    <div class="tab-pane" id="profile-tab-5">
                                        <div class="row">
                                            ...
                                            <div class="row mb-3">
                                                <label class="col-md-3 col-form-label" for="name1"> Caste
                                                    Preference</label>
                                                <div class="col-md-3">
                                                    <select class="selectpicker col-md-12 casteSelector" multiple
                                                        data-live-search="true" id="caste_perf_lists"
                                                        name="caste_perf_lists[]">
                                                        @foreach ($caste_list as $castes)
                                                            @if (!empty($user_preference['castePref']) && count(json_decode($user_preference['castePref'], true)) > 0)
                                                                @if (in_array($castes->id, json_decode($user_preference['castePref'], true)))
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-3">
                                                    <select name="foodchoice_pref" id="foodchoice_pref"
                                                        class="form-select">
                                            ...
                                            <div class="row mb-3">
                                                <label class="col-md-3 col-form-label" for="name1"> Marital
                                                    Status</label>
                                                <div class="col-md-3">
                                                ...
                                                <label class="col-md-3 col-form-label" for="name1"> Occupation
                                                    Preference</label>
                                                <div class="col-md-3">
            ...
            $(document).ready(function() {
                ...
                */
                ...
                $(document).on('click', '.checkNUpdate', function(e) {
                    ...
                    $('.personal_nav_link').addClass('active');
                    $('.photo_lonk').removeClass('active');
                    $('#profile-tab-4').removeClass('active');
                    $("#profile-tab-1").addClass('active');
                    $('.form_output').html('');
                    $('.custom_add_buttons').html(
                        '<li class="previous list-inline-item disabled form_output"> <button type="button" class="btn btn-light"><i class="mdi mdi-arrow-left me-1"></i> Back to Profession</button> </li> <li class="next list-inline-item float-end btn_div"> <button type="button" class="btn btn-success">Go To Final Submit <i class="mdi mdi-arrow-right ms-1"></i></button> </li>'
                    );
                    $('.first_link').html();
                    $.ajax({
                        type: "get",
                        ...
                        success: function(userResponse) {
                            $('.loader').hide();
                            console.log(userResponse.religionCode);
