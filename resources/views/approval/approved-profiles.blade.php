        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('updateuserprofile') }}" id="addLeadForm" autocomplete="off"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="row mb-3">
                                                ...
                                                <label class="col-md-3 col-form-label" for="lead_gender"> Gender</label>
                                                <div class="col-md-3">
                                    ...
                                    <ul class="pager wizard mb-0 list-inline mt-2">
                                        ...
                                        <li class="next list-inline-item float-end">
                                            <button type="button" class="btn btn-success">
                                                Go To Professional Details<i class="mdi mdi-arrow-right ms-1"></i>
                                            </button>
                                        </li>
                                        </li>
                                    </ul>
