                    ...
                    <div class="card-body table-responsive">
                        <div class="col-md-12 showPhotos">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row other_pic" style="height: 65vh; overflow-y:scroll">
                                    </div>
                                </div>
            ...
            function loadUserImages() {
                ...
                $.ajax({
                    ...
                    success: function(userPicResp) {
                        ...
                        otherPicHtml = "";
                        otherPicHtml +=
                            `<div class="col-md-12"><h4 class="card-title">${userPicResp.user_data.name}</h4>
                                                        <p class="card-text">${userPicResp.user_data.user_mobile}</p></div>`
                        'https://hansmatrimony.s3.ap-south-1.amazonaws.com/uploads/';
