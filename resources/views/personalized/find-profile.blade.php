                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <select class="selectpicker col-md-12 casteSelectorFind" multiple
                                                        ...
                                                        <div class="col-md-12">
                                                            <select class="col-md-12 selectpicker" id="manglik_status"
                                                                multiple name="manglik_status">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-check form-switch">
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="disabled_profiles" value="1"
                                                                    name="disabled_profiles" checked>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        <select name="castes" class="form-select" id="basic_profile_castes">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(profileResponse) {
                        if (profileResponse.type == true) {
                            ...
                            window.open(
                                `profile-lists-pdf?user_ids=${profileResponse.profile_list}`
                            );
                        } else {
            ...
            table_data = $('#products-datatable').DataTable({
                ...
                "ajax": {
                    ...
                    "data": function(d) {
                        ...
                        d.show_disabled = localStorage.getItem("showDisabled");
                    }
                },
                "columns": [{
                        data: null,
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            var filteredData = '';
                            filteredData +=
                                `<img src="https://s3.ap-south-1.amazonaws.com/hansmatrimony/uploads/${data.photo}" alt="image" class="avatar-sm rounded mt-2">
                                 <h5 class="m-0 d-inline-block align-middle">`;
                            if (data.is_premium == 1) {
                                filteredData +=
                                    `<a href="#" class="diplayUserDetails text-success" displayUser="${data.user_id}"> ${data.name}</a>`;
                            } else {
                                filteredData +=
                                    `<a href="#" class="text-dark diplayUserDetails" displayUser="${data.user_id}"> ${data.name}</a>`;
                            }
                            filteredData += '</h5>';
                            return filteredData;
                        }
                    ...
                    },
                    {
                        data: null,
                        render: function(data) {
                            return `<span class="badge bg-success populateKundliScore userKundliNo${data.user_id}" displayUser="${data.user_id}" birthDate="${data.birth_date}"><i class="mdi mdi-star"></i></span>`;
                        }
                    },
                    {
                        data: 'caste',
                    ...
                    },
                    {
                        data: null,
                        render: function(data) {
                            if (data.monthly_income > 1) {
                                return (data.monthly_income +
                                    'lpa');
                            } else {
                                return data.monthly_income + 'lpa';
                            }
            ...
            $(document).on('submit', '#filterForm', function(e) {
                ...
                if ($('#checkboxId').is(':checked')) {
                    disabledProfiles = $('#disabled_profiles').val();
                    localStorage.setItem("showDisabled", disabledProfiles);
                }
                ...
                $.ajax({
                    ...
                    success: function(notesResponse) {
                        if (notesResponse.type == true) {
                            $('#user_comments').val('');
                            var messageHtml = `<span class="text-success">Record Addedd</span>`;
            ...
            function getUserDetails() {
                ...
                $.ajax({
                    ...
                    success: function(userResponse) {
                        ...
                        localStorage.setItem("manglikStatus", userResponse.userpreference.manglikPref);
                        localStorage.setItem("foodChoice", userResponse.userpreference.food_choicePref);
            ...
            $(document).on('click', '.populateKundliScore', function(e) {
                ...
                var matchingDOB = $(this).attr('birthDate');
                ...
                $.ajax({
                    ...
                    type: "get",
                    data: {
                        "user_birth_date": userDOB,
                        "matching_dob": matchingDOB
                    },
            ...
            $(document).on('click', '.historyNav', function() {
                ...
                historyDetails(fifteenDaysAgo.toLocaleDateString(),today.toLocaleDateString());
            });
            ...
            function historyDetails(startDate,endDate) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                                                    ...
                                                    <div class="card product-box">
                                                        ...
                                                        <div class="product-info border-top p-3">
                                                            <div>
                                                                ...
                                                                <h6> Profile Sent Date : ${sendData.created_at}</h6>
                                                            </div>
                                                        </div> <!-- end product info-->
                                                    </div>
                                                </div>`;
                                                        ...
                                                        <div class="card product-box">
                                                            ...
                                                            <div class="product-info border-top p-3">
                                                                <div>
                                                                    ...
                                                                    <h6> Marital Status : ${sendData.marital_status}</h6>
                                                                    <h6> Caste : ${sendData.caste}</h6>
                                                                    <h6> Profile Liked Date : ${sendData.updated_at}</h6>
                                                                </div>
                                                            </div> <!-- end product info-->
                                                        </div>
                                                    </div>`
                                                    ...
                                                    <div class="card product-box">
                                                        ...
                                                        <div class="product-info border-top p-3">
                                                            <div>
                                                                ...
                                                                <h6> Marital Status : ${sendData.marital_status}</h6>
                                                                <h6> Caste : ${sendData.caste}</h6>
                                                                <h6> Profile Rejected Date : ${sendData.updated_at}</h6>
                                                            </div>
                                                        </div> <!-- end product info-->
                                                    </div>
                                                </div>`
                        ...
                        likedPremiumProfileHtml += `<div class="row">
                                                    <h4 class="text-primary mb-3 mt-3 text-left">Meetings With Match(${data.countlikedpremiummeetingslist})</h4>
                                                </div>
                                            <div class="row">`;
                        for (let v = 0; v < data.likedpremiummeetingslist.length; v++) {
                            const sendData = data.likedpremiummeetingslist[v];
                            likedPremiumProfileHtml += `<div class="col-3">
                                                    <div class="card product-box">
                                                        <div class="product-img">
                                                            <div class="p-3 text-center">
                                                                <img src="https://s3.ap-south-1.amazonaws.com/hansmatrimony/uploads/${sendData.photo}"
                                                        ...
                                                        <div class="product-info border-top p-3">
                                                            <div>
                                                                ...
                                                                <h6> Marital Status : ${sendData.marital_status}</h6>
                                                                <h6> Caste : ${sendData.caste}</h6>
                                                                <h6> Match Like Date : ${sendData.updated_at}</h6>
                                                            </div>
                                                        </div> <!-- end product info-->
                                                    </div>
                                                </div>`
                        }
                        likedPremiumProfileHtml += `</div>`;
                                                    ...
                                                    <div class="card product-box">
                                                        ...
                                                        <div class="product-info border-top p-3">
                                                            <div>
                                                                ...
                                                                <h6> Marital Status : ${sendData.marital_status}</h6>
                                                                <h6> Caste : ${sendData.caste}</h6>
                                                                <h6> Rejected By Match Date : ${sendData.updated_at}</h6>
                                                            </div>
                                                        </div> <!-- end product info-->
                                                    </div>
                                                </div>`
                                                    ...
                                                    <div class="card product-box">
                                                        ...
                                                        <div class="product-info border-top p-3">
                                                            <div>
                                                                ...
                                                                <h6> Marital Status : ${sendData.marital_status}</h6>
                                                                <h6> Caste : ${sendData.caste}</h6>
                                                                <h6> Meeting Date: ${sendData.updated_at}</h6>
                        ...
                        $('#likedPremiumProfileDetails').html(likedPremiumProfileHtml);
                    ...
                    success: function(premiumMeetingListResponse) {
                        ...
                        for (let t = 0; t < premiumMeetingListResponse.length; t++) {
                            ...
                            if (premiumUsers.status == 3 || premiumUsers.status == null) {
                                ...
                                if ((parsedData != null || parsedData != []) && parsedData.length > 0) {
                                    premiumMeetingList +=
