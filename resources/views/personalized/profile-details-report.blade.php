    ...
    <div class="container pdfDiv" id="pdf_data">
        <div class="row shadow" style="height: 99vh;  page-break-after: always;">
            ...
            <div>
                ...
                <div class="row">
                    <div class="col-4">
                        <img src="https://s3.ap-south-1.amazonaws.com/hansmatrimony/uploads/{{$user_detail_by_id->photo}}" height="250px" width="250px">
                    </div>
                    <div class="col-8">
                        <div class="row">
                            <div class="col-12"><h5><b>Name</b></h5>:{{$user_detail_by_id->name}}</div>
                        </div>
                        <div class="row">
                            <div class="col-12"><h5><b>Gender</b></h5>:{{$user_detail_by_id->gender}}</div>
                        </div>
                        <div class="row">
                            <div class="col-12"><h5><b>DOB</b></h5>:{{date('d/m/Y',strtotime($user_detail_by_id->birth_date))}}</div>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <h4 class="text-primary mb-3 mt-3 text-left">Meetings With Match</h4>
                </div>
                <div class="row">
                    @if($liked_premium_meetings_list ?? '')
                        @foreach($liked_premium_meetings_list ?? '' as $Data)
                            <div class="col-3">
                                <div class="card product-box">
                                    <div class="product-img">
                                        <div class="p-3 text-center">
                                    ...
                                    <div class="card product-box">
                                        ...
                                        <div class="product-info border-top p-3">
                                            <div>
                                                ...
                                                <h6> Marital Status : {{$Data->marital_status}}</h6>
                                                <h6> Caste : {{$Data->caste}}</h6>
                                                <h6> Profile Sent Date : {{date('d/m/Y',strtotime($Data->updated_at))}}</h6>
                                                <h6> Status : Yes </h6>
                                            </div>
                                        </div> <!-- end product info-->
                                    </div>
